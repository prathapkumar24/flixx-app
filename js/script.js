...
async function displayMovieDetails() {
  ...
  `;
  document.querySelector("#movie-details").appendChild(outerElement);
}
...
async function displayShowDetails() {
  ...
  const outerElement = document.createElement("div");
  outerElement.innerHTML = `<div class="details-top">
                <div>
                ${
                  show.poster_path
                    ? `<img
  ...
  document.querySelector("#show-details").appendChild(outerElement);
}
...
async function fetchAPIData(endpoint) {
  ...
  showSpinner();
  const response = await fetch(`${API_URL}${endpoint}?api_key=${API_KEY}&language=en-US`, options);
